package gabormakrai.dijkstra.main;

import java.util.Random;

import gabormakrai.dijkstra.performance.PerformanceEngine;
import gabormakrai.dijkstra.performance.PerformanceScenario;
import gabormakrai.dijkstra.performance.scenario.RandomBaseScenario;
import gabormakrai.dijkstra.performance.scenario.RandomKeithschwarzFibonacciPriorityQueueScenario;
import gabormakrai.dijkstra.performance.scenario.RandomNeo4jFibonacciPriorityQueueScenario;
import gabormakrai.dijkstra.performance.scenario.RandomNutchFibonacciPriorityQueueScenario;
import gabormakrai.dijkstra.performance.scenario.RandomTeneightyFibonacciPriorityQueueScenario;
import gabormakrai.dijkstra.performance.scenario.RandomTreeSetPriorityQueueScenario;
