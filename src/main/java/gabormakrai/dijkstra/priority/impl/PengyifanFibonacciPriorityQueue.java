...
import gabormakrai.com.pengyifan.commons.collections.heap.FibonacciHeap.Entry;

import gabormakrai.dijkstra.priority.PriorityObject;
import gabormakrai.dijkstra.priority.PriorityQueue;

public class PengyifanFibonacciPriorityQueue implements PriorityQueue<PriorityObject> {
