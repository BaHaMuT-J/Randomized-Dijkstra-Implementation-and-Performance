package org.dijkstra.performance.environment.binary.set.randomized;
...
public class BinHeapIntegerSetRandomizedEnvironment implements IntegerPerformanceEnvironment {
	...
	public BinHeapIntegerSetRandomizedEnvironment(int size, double p, int previousArrayBuilds, Random random) {
		this.size = size;
		this.p = p;
