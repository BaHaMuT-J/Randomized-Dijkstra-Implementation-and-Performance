...
public class BinHeapIntegerSetSequentialEnvironment implements IntegerPerformanceEnvironment {
	...
	public BinHeapIntegerSetSequentialEnvironment(int size, double p, int previousArrayBuilds, Random random) {
		this.size = size;
		this.p = p;
